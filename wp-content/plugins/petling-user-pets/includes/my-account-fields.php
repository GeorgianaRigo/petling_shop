        ...
        <div id="pet-repeater-container">
            <?php if ( ! empty( $pets ) ) : foreach ( $pets as $index => $pet ) : ?>
                <div class="pet-block">
                    ...
                    <p class="form-row form-row-last"><label>Βάρος (κιλά)</label>
                    <input type="text" class="input-text" name="pet_weight[]" placeholder="π.χ. 25.5" value="<?php echo esc_attr( $pet['weight'] ?? '' ); ?>"></p>
                    <div class="clear"></div>
