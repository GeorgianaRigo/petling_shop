...
<div class="vamtam-tabbed">
	...
	<ul class="vamtam-tabs">
		<li class="vamtam-tab"><label for="login-tab"><?php esc_html_e( 'Sign In', 'vamtam-petmania' ); ?></label></li>
		<li class="vamtam-tab"><label for="register-tab"><?php esc_html_e( 'Register', 'vamtam-petmania' ); ?></label></li>
	</ul>
	<div class="vamtam-tab-content u-columns col2-set" id="customer_login">
		...
		<?php endif; ?>
				...
				<h4><?php esc_html_e( 'Welcome Back', 'vamtam-petmania' ); ?></h4>
				<h5><?php esc_html_e( 'Please sign in to access your full account', 'vamtam-petmania' ); ?></h5>
