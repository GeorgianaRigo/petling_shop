...
class VamtamElementorBridge {
	...
	public static function add_sticky_header_bg_color_to_elementor_global_settings() {
		...
		$kit->add_repeater_row( 'system_colors', [
			...
			'title' => __( 'Sticky Header Bg Color', 'vamtam-petmania' ),
	...
	*/
		...
		if ( $use_el_global_defaults ) {
			...
			for ( $i = 1; $i <= 8; $i++ ) {
				...
				$kit->add_repeater_row( 'system_colors', [
					...
					'title' => sprintf( __( 'Accent %s', 'vamtam-petmania' ), $i ),
	...
	protected static function add_theme_fonts_to_elementor_global_fonts() {
		...
		if ( $use_el_global_defaults ) {
			...
			// Adding from vamtam_get_option().
			$our_fonts = [
				'primary-font' => __( 'Primary Font', 'vamtam-petmania' ),
				'h1'           => __( 'H1', 'vamtam-petmania' ),
				'h2'           => __( 'H2', 'vamtam-petmania' ),
				'h3'           => __( 'H3', 'vamtam-petmania' ),
				'h4'           => __( 'H4', 'vamtam-petmania' ),
				'h5'           => __( 'H5', 'vamtam-petmania' ),
				'h6'           => __( 'H6', 'vamtam-petmania' ),
			];
			...
			foreach ( $our_fonts as $font_prefix => $font_title ) {
				...
				$kit->add_repeater_row( 'system_colors', [
					...
					'title' => sprintf( __( '%s', 'vamtam-petmania' ), $font_title ),
	...
	public static function register_locations( $elementor_theme_manager ) {
		...
		$elementor_theme_manager->register_location(
			'page-title-location',
			[
				'label' => esc_html__( 'Page Title', 'vamtam-petmania' ),
				'multiple' => true,
	...
	public static function get_widget_mods_list() {
		...
		*/
		...
		$widget_mods_list = [
			...
			'call-to-action'                             => [ 'label' => __( 'Call To Action', 'vamtam-petmania' ) ],
			'form'                                       => [ 'label' => __( 'Form', 'vamtam-petmania' ) ],
			'tabs'                                       => [ 'label' => __( 'Tabs', 'vamtam-petmania' ) ],
			'image'                                      => [ 'label' => __( 'Image', 'vamtam-petmania' ) ],
			'icon-box'                                   => [ 'label' => __( 'Icon Box', 'vamtam-petmania' ) ],
			'nav-menu'                                   => [ 'label' => __( 'Nav Menu', 'vamtam-petmania' ) ],
			'section'                                    => [ 'label' => __( 'Section', 'vamtam-petmania' ) ],
			'toggle'                                     => [ 'label' => __( 'Toggle', 'vamtam-petmania' ) ],
			'table-of-contents'                          => [ 'label' => __( 'Table of contents', 'vamtam-petmania' ) ],
			'shortcode'                                  => [ 'label' => __( 'Shortcode', 'vamtam-petmania' ) ],
			'testimonial-carousel'                       => [ 'label' => __( 'Testimonial Carousel', 'vamtam-petmania' ) ],
			'woocommerce-menu-cart'                      => [ 'label' => __( 'Menu Cart', 'vamtam-petmania' ) ],
			'wc-loops-common-mods'                       => [ 'label' => __( 'WooCommerce Loops (common)', 'vamtam-petmania' ) ],
			'woocommerce-products'                       => [ 'label' => __( 'Products', 'vamtam-petmania' ) ],
			'wc-archive-products'                        => [ 'label' => __( 'Archive Products', 'vamtam-petmania' ) ],
			'wc-categories'                              => [ 'label' => __( 'Product Categories', 'vamtam-petmania' ) ],
			'woocommerce-cart'                			 => [ 'label' => __( 'Cart', 'vamtam-petmania' ) ],
			'woocommerce-product-related'                => [ 'label' => __( 'Product Related', 'vamtam-petmania' ) ],
			'woocommerce-product-upsell'                 => [ 'label' => __( 'Upsells', 'vamtam-petmania' ) ],
			'woocommerce-product-images'                 => [ 'label' => __( 'Product Images', 'vamtam-petmania' ) ],
			'woocommerce-product-price'                  => [ 'label' => __( 'Product Price', 'vamtam-petmania' ) ],
			'woocommerce-product-add-to-cart'            => [ 'label' => __( 'Add To Cart', 'vamtam-petmania' ) ],
			'woocommerce-product-data-tabs'              => [ 'label' => __( 'Product Data Tabs', 'vamtam-petmania' ) ],
			'woocommerce-product-rating'                 => [ 'label' => __( 'Product Rating', 'vamtam-petmania' ) ],
			'woocommerce-product-additional-information' => [ 'label' => __( 'Product Additional Information', 'vamtam-petmania' ) ],
			'archive-posts'                              => [ 'label' => __( 'Archive Posts', 'vamtam-petmania' ) ],
			'paypal-button'                              => [ 'label' => __( 'Paypal Button', 'vamtam-petmania' ) ],
			'posts'                                      => [ 'label' => __( 'Posts', 'vamtam-petmania' ) ],
			'popup' /* Not a widget but same logic */    => [ 'label' => __( 'Popup', 'vamtam-petmania' ) ],
			'post-comments'                              => [ 'label' => __( 'Post Comments', 'vamtam-petmania' ) ],
			'wc-elements'                                => [ 'label' => __( 'WooCommerce Pages', 'vamtam-petmania' ) ],
			'woocommerce-cart'                           => [ 'label' => __( 'WooCommerce Cart', 'vamtam-petmania' ) ],
			'woocommerce-checkout-page'                  => [ 'label' => __( 'WooCommerce Checkout', 'vamtam-petmania' ) ],
			'woocommerce-purchase-summary'               => [ 'label' => __( 'WooCommerce Purchase Summary', 'vamtam-petmania' ) ],
			'woocommerce-my-account'                     => [ 'label' => __( 'WooCommerce My Account', 'vamtam-petmania' ) ],
			'wp-widget-instagram-feed-widget'            => [ 'label' => __( 'Instagram Feed', 'vamtam-petmania' ) ],
			'wp-widget-dgwt_wcas_ajax_search'            => [ 'label' => __( 'FiboSearch Bar', 'vamtam-petmania' ) ],
			'wp-widget-berocket_aapf_group'              => [ 'label' => __( 'AAPF Filters Group', 'vamtam-petmania' ) ],
		];
	...
	public static function get_wc_mods_list() {
		...
		$wc_mods_list = [
			...
			'wc_products_new_badge' => [
				'label'       => __( '"New" badge for products.', 'vamtam-petmania' ),
				'description' => __( 'Adds an option to allow marking products as new. The option is added on the products edit page under the advanced tab.', 'vamtam-petmania' ),
			],
		];
	...
	*/
	...
	public static function extract_zip( $file, $to ) {
		...
		if ( ! $unzip_result ) {
			$unzip_result = new \WP_Error( 'error', esc_html__( 'Could not unzip or empty archive.', 'vamtam-petmania' ) );
		}
